...
%define flavor xanmod-exptl
Name: kernel%{?flavor:-%{flavor}}
Summary: The Linux Kernel with XanMod Patches and experimental options

%define _basekver 6.0
...
Release:%{flaver}.0e20221004%{?dist}
...
# exptl 2021/06/22 -- patch top-level Makefile to always use the LLVM toolchain
# exptl 2021/06/30 -- adapt 5.13 changes
# exptl 2021/07/05 -- fix broken 5.13 changes (pagure #4), use LLVM ThinLTO instead of Full LTO
# exptl 2021/09/02 -- adapt 5.14 changes
# exptl 2021/09/20 -- adapt 5.14.6+ changes
# exptl 2021/11/05 -- adapt 5.15 changes
# exptl 2022/01/13 -- adapt 5.16 changes
# exptl 2022/03/22 -- adapt 5.17 changes
...
# Extract and apply patch to tree
...
# exptl 2021/06/22 -- patch top-level Makefile to always use the LLVM toolchain
patch ./Makefile -i %{PATCH1000}

# exptl 2021/06/11 -- use LLVM+LTO
# exptl 2021/07/05 -- fix broken 5.13 changes (pagure #4), use LLVM ThinLTO instead of Full LTO
# exptl 2021/07/08 -- use LLVM Full LTO to try and fix pagure #6
...
%build
make %{?_smp_mflags} EXTRAVERSION=-%{krelstr} LLVM=1 LLVM_IAS=1
LLVM=1 LLVM_IAS=1 clang ./scripts/sign-file.c -o ./scripts/sign-file -lssl -lcrypto
